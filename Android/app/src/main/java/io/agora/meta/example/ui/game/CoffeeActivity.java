...
public class CoffeeActivity extends Activity implements IMetaEventHandler, IRtcEventCallback {
    ...
    public void onJoinChannelSuccess(String channel, int uid, int elapsed) {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                mAudioFileReader = new AudioFileReader(CoffeeActivity.this, new AudioFileReader.OnAudioReadListener() {
                    @Override
