...
import io.agora.meta.example_voice_driver.MainApplication;

public class MMKVUtils {
    private static volatile MMKVUtils mmkvUtils;
    private static final String PREFERENCE_NAME = "meta";
    ...
    public static MMKVUtils getInstance() {
        if (null == mmkvUtils) {
            synchronized (MMKVUtils.class) {
                if (null == mmkvUtils) {
                    mmkvUtils = new MMKVUtils(MetaConstants.MMKV_ID);
                }
            }
        }
        return mmkvUtils;
