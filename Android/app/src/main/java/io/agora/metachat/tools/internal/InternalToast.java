package io.agora.metachat.tools.internal;
...
public final class InternalToast {
    ...
    public static void show(CharSequence notice, int toastType,int duration) {
        ...
        new Builder(mApp)
                ...
                .setOffset((int) DeviceTools.dp2px(200))
...
//            toast.setMargin(0, 0);
            View rootView = LayoutInflater.from(context).inflate(R.layout.mchat_view_toast_custom, null);
            ...
            if (toastType == COMMON) {
                ...
                if (toastType == TIPS) {
                    imageView.setImageResource(R.drawable.mchat_ic_toast_hint);
                } else {
                    imageView.setImageResource(R.drawable.mchat_ic_toast_error);
                }
            }
