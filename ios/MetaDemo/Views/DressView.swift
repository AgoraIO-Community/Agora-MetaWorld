...
//    public var collectionViewCellClickBlock: ((Int) -> Void)?
    public weak var dressViewEventDelegate: DressViewEventDelegate?
...
//            scrollViewLabelClickBlock?(self.dressIndex)
            dressViewEventDelegate?.scrollViewLabelClick(self.dressIndex)
        } else {
            slider.isHidden = false
//            scrollViewLabelClickBlock?(self.faceIndex)
            dressViewEventDelegate?.scrollViewLabelClick(self.faceIndex)
        }
...
//        sliderValueChangedBlock?(slider.value)
        self.dressViewEventDelegate?.sliderValueChanged(slider.value)
...
extension DressView: UICollectionViewDataSource {
...
extension DressView: UICollectionViewDelegateFlowLayout {
...
//        collectionViewCellClickBlock?(indexPath.row)
        self.dressViewEventDelegate?.collectionViewCellClick(indexPath.row)
    }
}
...
//        scrollViewLabelClickBlock?(index)
        self.dressViewEventDelegate?.scrollViewLabelClick(index)
