...
__attribute__((visibility("default"))) @interface AgoraResourceInfo : NSObject
@property(copy, nonatomic) NSString *_Nullable resourceId;
@property(copy, nonatomic) NSString *_Nullable thumbnailUrl;
...
@property(copy, nonatomic) NSString *_Nullable customInfos;
@end

__attribute__((visibility("default"))) @interface AgoraResourceInfoList : NSObject
@property(copy, nonatomic) NSArray<AgoraResourceInfo *> *_Nullable infoList;
@property(assign, nonatomic) NSUInteger ResourceInfoListLength;
@end
...
/** A class for bundle resource sync.
 */
__attribute__((visibility("default"))) @interface AgoraResourceConfig : NSObject
@property(copy, nonatomic) NSString *_Nonnull appid;
@property(copy, nonatomic) NSString *_Nonnull token;
@property(assign, nonatomic) NSUInteger uid;
@property(copy, nonatomic) NSString *_Nullable root_path;
@end
