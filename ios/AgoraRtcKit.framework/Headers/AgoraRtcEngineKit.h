...
- (BOOL)onPreEncodeScreenVideoFrame:(AgoraOutputVideoFrame * _Nonnull)videoFrame dstFrame:(AgoraOutputVideoFrame *_Nullable* _Nullable)dstFrame;
...
- (void)rtcEngine:(AgoraRtcEngineKit * _Nonnull)engine
    ResourceInfoListUpdated:(AgoraResourceInfoList* _Nonnull)resourceInfoList
    code:(AgoraResourceErrorType)code;

- (void)rtcEngine:(AgoraRtcEngineKit * _Nonnull)engine
    ResourceInfoUpdated:(AgoraResourceInfo* _Nonnull)resourceInfo
    code:(AgoraResourceErrorType)code;

- (void)rtcEngine:(AgoraRtcEngineKit * _Nonnull)engine
    DownloadResourceStateChanged:(NSString* _Nonnull)rcId state:(AgoraResourceState)state
    progress:(NSInteger)progress reason:(NSInteger)reason;
/**
...
/**
 * Sync resource info list for the `onResourceInfoListUpdated` callback.
 *
 * @param AgoraResourceConfig Resource configuration

 * @return
 * - 0: Success.
 * - < 0: Failure.
 */
- (int)syncResourceInfoList:(AgoraResourceConfig* _Nonnull)resourceConfig;

/**
 * Download specific resource id, for the `onDownloadResourceStateChanged` callback
 * 
 * resource id is get from onResourceInfoListUpdated or onResourceInfoUpdated.
 *
 ...
 * - < 0: Failure.
 */
-(int)downloadResource:(NSString*  _Nonnull)id subPath:(NSString* _Nullable)subPath;
 ...
 * - < 0: Failure.
 */
-(int)getResourceInfo:(NSString*  _Nonnull)id;
...
/** Adds the URL to which the host publishes the stream. (CDN live only.)
 ...
 @note * Ensure that this API is called AFTER you have joined the channel.
...
- (NSInteger)takeSnapshot:(NSString* _Nonnull)channel uid:(NSInteger)uid filePath:(NSString* _Nonnull)filePath completion:(id<AgoraSnapshotCallbackDelegate> _Nonnull)snapshotDelegate;
...
/** Enable/ disable Fish Eye Correction and set fish eye parameters
 ...
 @param params fish eye function parameters
          enable: true enable fish eye function
                  false disable fish eye function
          x_center, y_center: value in [0.4, 0.6] default x_center is 0.49, y_center is 0.48
                scale_factor: value in [1, 5] default is 4.5
                focal_length: value in [20, 40] default is 31
                pol_focal_length: value in [20, 40] default is 31
                ss[0~4] is the property of the fisheye mirror
  @return
          - 0: Success.
          - <0: Failure
 */
