...
public:
  ...
  virtual void onLock(const char *roomName, const char *userId, const char *key, const char *value) {}
  virtual void onUnlock(const char *roomName, const char *userId, const char *key) {}
...
public:
  ...
  virtual int tryLock(const char *roomName, const char *key, const char *value, int64_t lockTimeMs) = 0;
  virtual int unlock(const char *roomName, const char *key) = 0;
