...
typedef NS_ENUM(NSInteger, AgoraResourceState) {
    AgoraResourceStateIdle = 0,
    AgoraResourceStateDowmloading = 1,
    AgoraResourceStateDownloaded = 2,
    AgoraResourceStateDownloadFailed = 3
};

typedef NS_ENUM(NSInteger, AgoraResourceErrorType) {
    AgoraResourceErrorOK = 0,
    AgoraResourceErrorNotFound = 1,
    AgoraResourceErrorInvalidToken = 2,
    AgoraResourceErrorNeedSync = 3
};
...
typedef NS_ENUM(NSInteger, AgoraAudioProcessChannels) {
  ...
  AgoraAudioProcessChannelsStereo = 2,
};
